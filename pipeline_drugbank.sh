...
python3 src/train_rnn.py predict temp/dditestdrugbank words words
python3 src/ddi_evaluation.py convert words_dditestdrugbank_results.txt
...
python3 src/train_rnn.py predict temp/dditestdrugbank wordnet words wordnet
python3 src/ddi_evaluation.py convert wordnet_dditestdrugbank_results.txt
java -jar evaluateDDI.jar data/DDICorpus/Test/DDIExtraction/DrugBank/ wordnet_dditestdrugbank_results.txt.tsv

#python3 src/train_rnn.py train_test temp/dditrain chebi_common words common_ancestors
python3 src/train_rnn.py predict temp/dditestdrugbank chebi_common words common_ancestors
python3 src/ddi_evaluation.py convert chebi_common_dditestdrugbank_results.txt
java -jar evaluateDDI.jar data/DDICorpus/Test/DDIExtraction/DrugBank/ chebi_common_dditestdrugbank_results.txt.tsv

#python3 src/train_rnn.py train_test temp/dditrain chebi_concat words concat_ancestors
python3 src/train_rnn.py predict temp/dditestdrugbank chebi_concat words concat_ancestors
python3 src/ddi_evaluation.py convert chebi_concat_dditestdrugbank_results.txt
java -jar evaluateDDI.jar data/DDICorpus/Test/DDIExtraction/DrugBank/ chebi_concat_dditestdrugbank_results.txt.tsv

#python3 src/train_rnn.py train_test temp/dditrain full_model words wordnet common_ancestors concat_ancestors
python3 src/train_rnn.py predict temp/dditestdrugbank full_model words wordnet common_ancestors concat_ancestors
python3 src/ddi_evaluation.py convert full_model_dditestdrugbank_results.txt
java -jar evaluateDDI.jar data/DDICorpus/Test/DDIExtraction/DrugBank/ full_model_dditestdrugbank_results.txt.tsv
